angular.module('templates-app', ['templates/install.tpl.html', 'templates/map.tpl.html', 'templates/splash.tpl.html']);

angular.module("templates/install.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/install.tpl.html",
    "<div class=\"install\">\n" +
...
angular.module("templates/map.tpl.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("templates/splash.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/splash.tpl.html",
    "<div class=\"splash\">\n" +
    ...
    "      </div>\n" +
    "      <button ng-disabled=\"submitted\" name=\"splashSubmit\" class=\"splash-submit\" type=\"submit\">Let's Go</button>\n" +
    "    </form>\n" +
    "  </div>\n" +
    "</div>");
}]);
