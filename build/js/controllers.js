...
birdur.controller('BirdurCtrl', [
  '$scope',
  '$rootScope',
  'InstallCheck',
  function ($scope, $rootScope, InstallCheck) {
  ...
  'GeoLoc',
  'Map',
  function ($scope, $location, UserInput, GeoLoc, Map) {
  ...
  'UserInput',
  'GeoLoc',
  function ($scope, $http, $log, $location, $routeParams, eBirdRef, eBirdObs, Map, UserInput, GeoLoc) {
    $scope.errorMessage = '';
